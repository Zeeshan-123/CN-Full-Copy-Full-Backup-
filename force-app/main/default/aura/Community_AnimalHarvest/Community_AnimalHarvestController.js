({
    ...
    save: function(component, event, helper){
        ...
        var controlselectAuraIds1 = ["harvestDate", "landType", "methodOfHarvest", "antlerStatus", "ageGroup", "countyHarvest"];
        debugger; 
        
        if(antlerStatus === 'true'){
            controlselectAuraIds1.push("pointsLeft", "pointsRight");
        ...
        else if(antlerStatus === 'true' && (CVCase.Points_Left__c < 0 || CVCase.Points_Left__c > 25)){
            helper.showErrorMessage(component, event, helper, 'Points Left must be between 0 and 25.');
            errorExist = true; 
        }
        else if(antlerStatus === 'true' && (CVCase.Points_Right__c < 0 || CVCase.Points_Right__c > 25)){
            helper.showErrorMessage(component, event, helper, 'Points Right must be between 0 and 25.');
            errorExist = true; 
        }
