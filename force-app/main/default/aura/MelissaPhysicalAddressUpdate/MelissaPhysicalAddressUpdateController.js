        ...
        action.setCallback(this,function(response)
                           {
                               ...
                               if (state === "SUCCESS")
                               {
                                   ...
                                   component.find("MailingStreetInput").set("v.value", resultData.RRRCase.Physical_Street__c);
                                   component.set("v.address1", resultData.RRRCase.Physical_Street__c);
                                   component.find("MailingCityInput").set("v.value", resultData.RRRCase.Physical_City__c);
                                   component.set("v.city", resultData.RRRCase.Physical_City__c);
                                   component.find("MailingzipInput").set("v.value", resultData.RRRCase.Physical_ZipPostal_Code__c);
                                   component.set("v.zipcode", resultData.RRRCase.Physical_ZipPostal_Code__c);
                                   component.find("MailingAddress2Input").set("v.value", resultData.RRRCase.Physical_Address2__c);
                                   component.set("v.address2", resultData.RRRCase.Physical_Address2__c);
                                   component.find("MailingSuiteInput").set("v.value", resultData.RRRCase.Physical_Suite__c);
                                   component.set("v.suite", resultData.RRRCase.Physical_Suite__c);
                                   component.set("v.isAddressChanged", resultData.RRRCase.Is_Physical_Address_Changed__c);
                                   component.set("v.isManual", resultData.RRRCase.Physical_IsManual__c);
                                   component.set("v.location", resultData.RRRCase.Physical_Melissa_Address__c);
                                   component.set("v.selectedAddress", resultData.RRRCase.Physical_Melissa_Address__c);
                                       ...
                                       $A.getCallback( function() 
                                                      {
                                                          ...
                                                          var mailingCountryVal = resultData.RRRCase.Physical_Countries__c; 
                                                          ...
                                                          {
                                                              component.find("MailingCountryInput").set("v.value", resultData.RRRCase.Physical_Countries__c);
                                                              component.set("v.country", 'United States');
                                                          }
                                                          
                                                          $A.enqueueAction(component.get('c.ObjFieldByMailingParent'));
                                                          var mailingStateVal = resultData.RRRCase.Physical_States__c;
                                                          var mailingOtherStateVal	=	resultData.RRRCase.Other_Physical_State__c;
