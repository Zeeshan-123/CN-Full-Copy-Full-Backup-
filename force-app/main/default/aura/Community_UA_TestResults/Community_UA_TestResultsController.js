    ...
    doInit : function(component, event) {
        ...
        action.setCallback(this,function(response){
            ...
            if (state === "SUCCESS"){
                ...
                console.log( resultData.System_Num_Days__c  );
                
                if(resultData.RecordType.DeveloperName == 'ERM_Patient'){
                    if(resultData.Updated_by_Cerner__c){
                    if(resultData.System_Num_Days__c > 90 ){
                        component.set("v.isERMPatientAccount", true);  
                       component.set("v.responseNotSubmitted", true); 
                    }else if(resultData.System_Num_Days__c < 11 ){
                        component.set("v.isERMPatientAccount", false); 
                    }else if(resultData.System_Num_Days__c > 10 && resultData.System_Num_Days__c < 91 ){
                        component.set("v.isERMPatientAccount", false); 
                    }
                    }else{
                     component.set("v.isERMPatientAccount", true);     
